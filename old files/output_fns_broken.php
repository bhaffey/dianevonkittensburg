...
//replaced with display_shipping_options
...
?>
  ...
  <tr><td align="left">Shipping Options</td>
      <td align="right"> <p>
            <input type="radio" name="shipping" id="USPS" onclick="checkShippingSelection(4.95)">USPS Priority Mail: $4.95</input><br>
            <input type="radio" name="shipping" id="UPS" onclick="checkShippingSelection(12.95)">UPS 2 Day Air: $12.95</input><br>
            <input type="radio" name="shipping" id="FedEx" onclick="checkShippingSelection(13.95)">Fed Ex 2 Day Air: $13.95</input><br>
      </p></td>
  </tr>
...
function display_total_inclshipping () {
  // display table row with shipping cost and total price including shipping
?>
  <table border="0" width="100%" cellspacing="0">
  <tr><td align="left">Shipping</td>
