...
<?php
  ...
  <div id="navbar">
        ...
        <ul>
        <li><a href="show_cat.php?catid=sweaters">Sweaters</a></li>
        <li><a href="show_cat.php?catid=jackets">Jackets</a></li>
        <a href="index.php"><img src="images/dvk.jpg"></img></a>
        <li><a href="show_cat.php?catid=harnesses">Harnesses</a></li>
        <li><a href="show_cat.php?catid=accessories">Accessories</a></li>
  </div>
  ...
  if (!is_array($items_array)) {
    ...
    foreach ($items_array as $row) {
      ...
      if (@file_exists("images/".$row['category'].".jpg")) {
        $title = "<img src=\"images/hoodie_smaller.jpg\"
                  height=\"250px\" width=\"170px\" 
                  style=\"border: 1px solid black\"/>";

        //"<img src=\"images/".$row['category'].".jpg\"
          //        style=\"border: 1px solid black\"/>";
        do_html_url($url, $title);
      } else {
        echo "&nbsp;";
  ...
  if (is_array($item)) {
    ...
    //if (@file_exists("images/".$item['image_loc'].".jpg"))  {
      ...
      //if(($size[0] > 0) && ($size[1] > 0)) {
        ...
        echo "<td><img src=\"images/hoodie_smaller.jpg\"
